...
%	
	...
	\begin{frame} 
		...
		\end{enumerate}
		\justifying Man kann diesen Prozess nun noch weiter durchführen, allerdings wird man die nie die leere Klausel ableiten können. Die Formel ist daher erfüllbar.
		\solutionmarkB
	\end{frame}
