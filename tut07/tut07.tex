...
%	\institute{Lehrstuhl für Grundlagen der Programmierung}
	...
	\begin{frame}\frametitle{CYK: Praktische Umsetzung}
		...
		\begin{itemize}
			...
			\item Fixiere Element $\blacksquare$: sei $\blacktriangleright$ in der gleichen Zeile ganz links und $\blacktriangledown$ direkt unten drunter 
			\begin{itemize}
				\item wenn eine Regel $\blacklozenge \to \blacktriangleright \blacktriangledown$, dann füge $\blacklozenge$ zu $\blacksquare$ hinzu
				\item schiebe $\blacktriangleright$ nach rechts und $\blacktriangledown$ nach unten und wiederhole
			\end{itemize}
		\end{itemize}
		...
		\begin{center}
			\scalebox{0.7}{%
				\begin{tabular}{c|c|c|c|c|c|}
					...
					\MEC{\Sterm{+}} &  
					& $\blacktriangleright$ & $V[2,3]$ & $\blacksquare \cup \blacklozenge$ & $V[2,5]$ \\\cline{3-6}
					\MEC{\Sterm{b}} &\MEC{}   &
